...
# summarize the review for the shipping department
prompt = f"""
Your task is to generate a short summary of a product 
...
# summarize the review for the pricing department
prompt = f"""
Your task is to generate a short summary of a product 
review from an ecommerce site to give feedback to the 
Pricing department. 
...
Summarize the review below, delimited by triple 
backticks, in at most 30 words, and focusing on any aspects
that mention pricing of the product. 

Review: ```{prod_review}```
"""

# summarize extract" instead of "summarize"
prompt = f"""
