...
prompt = f"""
Translate the following python dictionary from JSON to \
a table in the HTML format: 
{data_json}
"""
response = get_completion(prompt)
print(response)
...
Redlines = import_module("redlines").Redlines
...
#reference: https://writingprompts.com/bad-grammar-examples/
